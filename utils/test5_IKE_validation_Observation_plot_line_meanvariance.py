...
tmp1_obs = tmp1["predicted"].tolist()
...
for k, [field_mean, field_var] in enumerate([[plot_eta_mean, plot_eta_var], [plot_u_mean, plot_u_var], [plot_v_mean,
    ...
    for i in range(len(test_nodes)):
        ...
        if k == 0:
            ...
            plt.savefig(output_dir + 'eta_validation_line_mean_variance_' + test_node_str[i][:7] +'.png')
        elif k == 1:
            ...
            plt.savefig(output_dir + 'u_validation_line_mean_variance_' + test_node_str[i][:7] +'.png')
        else:
            ...
            plt.savefig(output_dir + 'v_validation_line_mean_variance_' + test_node_str[i][:7] +'.png')
