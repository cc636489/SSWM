...
mesh = RectangleMesh(Point(0, 0), Point(100, 50), 4, 2)
...
#    import pdb;pdb.set_trace()
    ...
    for i, item in enumerate(test_nodes): 
        ...
        # save to file
        np.save(output_dir + "binrandom_surrogate_u_samples_order_"+str(item[0])+"_"+str(item[1])+"_"+str(st_order), u_random_output)
        np.save(output_dir + "binrandom_surrogate_v_samples_order_"+str(item[0])+"_"+str(item[1])+"_"+str(st_order), v_random_output)
        np.save(output_dir + "binrandom_surrogate_eta_samples_order_"+str(item[0])+"_"+str(item[1])+"_"+str(st_order), eta_random_output)
