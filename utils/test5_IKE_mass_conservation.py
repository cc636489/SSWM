...
out_put_dir = "/workspace/Documentation/Research_Doc/SFEM_Doc/4-NS-results-and-tests/regression_test/SSWM_comparison_Gulf_wind_IKE/IKE_correct_bug_with_atmos_press/"
