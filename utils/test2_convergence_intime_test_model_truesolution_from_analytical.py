...
timestep = 0
u_file = XDMFFile(loc+"u_"+str(timestepsize)+".xdmf")
eta_file = XDMFFile(loc+"eta_"+str(timestepsize)+".xdmf")
...
f = open(loc+'error_u_l2_'+str(timestepsize), "w+")
for err in error_u_l2:
    f.write(str(err))
    f.write("\n")
f.close()

f2 = open(loc+'error_eta_l2_'+str(timestepsize), "w+")
for err in error_eta_l2:
    f2.write(str(err))
    f2.write("\n")
f2.close()

f = open(loc+'error_u_h1_'+str(timestepsize), "w+")
for err in error_u_h1:
    f.write(str(err))
    f.write("\n")
f.close()

f2 = open(loc+'error_eta_h1_'+str(timestepsize), "w+")
