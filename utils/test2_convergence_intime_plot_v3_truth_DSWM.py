...
mesh_size = "timestepsize to 10.0s: 5s, 2.5s, 1.25s, 0.625s, 0.3125s"
...
for l, k in enumerate(hsize):
    ...
    with open(feta_l2 + str(int(k)), 'r') as f:
        for line in f:
            pass
        eta_l2[l][0] = float(line)

    with open(fuv_l2 + str(int(k)), 'r') as f:
        for line in f:
            pass
        u_l2[l][0] = float(line)

#    with open(feta_h1 + str(int(k)), 'r') as f:
#        for line in f:
#            pass
#        eta_h1[l][0] = float(line)
#
#    with open(fuv_h1 + str(int(k)), 'r') as f:
#        for line in f:
#            pass
#        u_h1[l][0] = float(line)
