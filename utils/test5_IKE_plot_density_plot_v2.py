...
node_x = [346974.525421, 582699.363816, 642084.289864]
node_y = [3278821.479, 3280530.02913, 3277486.52114]
node_str =["galveston entrance", "right coast", "the most right coast"]
node_str_node_number = ["5171", "3516", "3702"]
    ...
    for i, item in enumerate(test_nodes): 
        ...
        for j, field in enumerate([u_random_output, v_random_output, eta_random_output]):
            ...
            try:
                ...
                #else:
                    sns.distplot(field, label=str(n_sample)+' samples', kde_kws={"lw": 2, "label": "KDE"})
