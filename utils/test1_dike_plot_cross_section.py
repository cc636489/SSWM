...
for i, x in enumerate(test_node_x): 
    ...
    plt.scatter(u_truth_surface, y_truth_surface, marker='o', s=60,  facecolors='none', edgecolors='b')
    plt.scatter(u_truth_Base, y_truth_Base, marker='o', s=60,  facecolors='none', edgecolors='y')
