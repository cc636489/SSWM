...
out_put_dir = "/workspace/Documentation/Research_Doc/SFEM_Doc/4-NS-results-and-tests/test2_res/" \
            "20181001_generalized/mode_0_fine_mesh/mass_conservation_plot/"
...
plt.legend(["zoom in"])
# plt.show()
plt.savefig(out_put_dir + "Conservation_of_mass_zoom_in_6_hr.png")
...
plt.legend(["zoom out"])
# plt.show()
plt.savefig(out_put_dir + "Conservation_of_mass_zoom_out_6_hr.png")
