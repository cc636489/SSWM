...
prefix = "/workspace/Documentation/Research_Doc/SFEM_Doc/4-NS-results-and-tests/pets_"

mesh = Mesh("inlet_adh_sswm_finer.xml")
...
'''
nc = Dataset("inlet_adh_sswm_finer.nc", 'r', format='NETCDF4')
...
boundaries = MeshFunction("size_t", mesh, "inlet_adh_sswm_finer_facet_region.xml")
