...
prefix = "/workspace/Documentation/Research_Doc/SFEM_Doc/4-NS-results-and-tests/" \
         "test8_SUPG_SamgLily_crosswind/test4_supg_crosswind_woles_wofric"
...
if include_crosswind:
    ...
    F_u_tent += conditional(lt(assemble(du_norm*dx), 1e-3), Constant(0.0), r2u) + \
                conditional(lt(assemble(dv_norm*dx), 1e-3), Constant(0.0), r2v)
