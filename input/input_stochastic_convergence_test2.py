...
output_dir = "/workspace/Documentation/Research_Doc/SFEM_Doc/4-NS-results-and-tests/test2_res/convergence_pdfs/"
output_str = "test2_stochastic_order_10_"
bath_file = " "
mesh_file = " "
wind_file = " "
boundary_file = " "
...
sto_poly_deg = 10  # polynomial chaos order is 2.
...
domain = {"rectangle": (0, 0, 100, 50, 10, 5)}
...
initial_eta = {"vary": "0.1*q0*sp.cos(pi/100.0*x)"}
