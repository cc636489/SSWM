...
outputdir = "/workspace/Documentation/Research_Doc/SFEM_Doc/4-NS-results-and-tests/test3_res_wiLES/"
outputstr = "fem_verified_test3_"
...
bathymetry = {"class": ['type1', 400, 600, '-3.0 * q0 + 6.0 * q1 + 2.0', '-3.0 * q0 * ((x-500.0)/100.0)**4 + 6.0 * q1 * ((x-500.0)/100.0)**2 + 2.0']}
