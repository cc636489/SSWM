...
outputdir = "/workspace/Documentation/Research_Doc/SFEM_Doc/4-NS-results-and-tests/test4_code_regressiontest_wiLES/test4_sto_2/"
outputstr = "fem_verified_test4_"
...
domain = {"importfile": "test_case_4_les.xml"}
...
# boundary condition
# first way:
bcfile = "test_case_4_les_facet_region.xml"
boundary_u = {1: "freeslipxx", 2: "freeslipyy"} # "freeslipxx/freeslipyy/noslip/(str, tuple)/(float, tuple)"
